   ...
   diceImage.src = `./images/${numberOfDice}.PNG`;
    ...
    if (numberOfDice == 1) {
        ...
        if (player1Turn) {
            ...
            document.getElementById('Section1').setAttribute('class', 'col-lg-4 col-sm-12 col-md-12 box d-flex flex-direction-row')
            ...
            document.getElementById('Section2').setAttribute('class', 'col-lg-4 col-sm-12 col-md-12 box d-flex flex-direction-row')
